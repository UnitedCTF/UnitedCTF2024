...
FLAG = b"flag-aa2181b8db80934befc12a9faf688b"
DB = "db/portal.db"
...
# EASY challenge, SSH based SQLi two flag track.
# 1 - Bypass authentication with a classic SQLi in the password for any user. (maybe find something else)
# 2 - SQLi injection in the project field, allowing to create a malicious pickle object and trigger it when checking tickets.
